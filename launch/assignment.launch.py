...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('world', default_value='scenario24', description='Gazebo World'),
...
def generate_launch_description():
    ...
    assignment24 = Node(
	namespace=('/a200_0000/cmd_vel'),
	package="kmf3_ros360_cpp",
	executable="assignment24",
	name="assignment24",
	remappings=[
	('/tf', 'tf'),
	('/tf_static', 'tf_static'),
